      ...
      return (
          <div className="space-y-4">
              <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-zinc-100">Review Import ({parsedData.length} trades)</h3>
                  <div className="space-x-2">
                       <Button variant="outline" onClick={() => { setParsedData([]); setPreviewOpen(false); }}>Cancel</Button>
